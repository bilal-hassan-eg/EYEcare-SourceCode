...
{
    internal class add_show_operations
    {
        private Iqafla _qafla;
        public string AccountName;
        string location;
        string data;
        public add_show_operations(qafla qafla, string data, string Accountname, string location)
        {
            this._qafla = qafla;
            this.data = data;
        ...
        public void insert_showed_operation()
        {
            ...
            catch
           {
            ...
            conn.Close();
            conn.Open();
            string sql = $"UPDATE {AccountName} SET تم=N'عرض' WHERE [كود المريض]={_qafla.code}";
