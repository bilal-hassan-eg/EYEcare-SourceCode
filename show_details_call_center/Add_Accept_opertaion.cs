...
{
    internal class Add_Accept_opertaion
    {
        private Iqafla _qafla;
        public string AccountName;
        string location;
        string data;
        public Add_Accept_opertaion(qafla qafla, string data, string Accountname, string location)
        {
            this._qafla = qafla;
            this.data = data;
        ...
        public void insert_Aceepted_operation()
        {
            ...
            conn.Close();
            conn.Open();
            string sql = $"UPDATE {AccountName} SET تم=N'اكدت' WHERE [كود المريض]=N'{_qafla.code}'";
